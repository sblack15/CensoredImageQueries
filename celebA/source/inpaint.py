...
if __name__ == '__main__':
    ...
    parser.add_argument("--masked_feature", type=str, default='face',
                        help="what facial region to mask (choices: face, eyes, nose, mouth)'")
    parser.add_argument("--method_name", type=str, default='NS', help='name of implemented method')
    parser.add_argument("--inpainted_dir", type=str, default='celebA/images/inpainted')
    parser.add_argument("--gpu", type=str, default="0", help='GPU id, -1 for CPU')

    args = parser.parse_args()

    output_dir = os.path.join(args.inpainted_dir, args.masked_feature, args.method_name)
